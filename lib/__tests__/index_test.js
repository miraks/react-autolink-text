...
var createRenderer = _React$addons$TestUtils.createRenderer;
...
describe('<AutoLinkText />', function () {
  ...
  function renderText(text) {
    ...
    return _reactAddons2['default'].renderToStaticMarkup(_reactAddons2['default'].createElement(_index2['default'], _extends({ text: text }, props)));
  }
